# Contributing to Flight Landing Page

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Landing Page? Welcome! Please read this
...
You can help Flight Landing Page by helping others who use it and need support.
...
If you find a bug - behaviour of Flight Landing Page code or documentation
...
We want to improve the quality of Flight Landing Page and good bug reports are
...
Flight Landing Page is Open Source and comes without warranty.
...
Flight Landing Page in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Landing Page and really improve it. The more
...
applied to Flight Landing Page itself.
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Landing Page developers also have their regular
